...
All of our customer's phone numbers have been scrambled, and we need those phone numbers to annoy them 
with endless sales calls!
...
function isItANum(str) {
   var mat = /[0-9]/g; 
   var numbers = str.match(mat).join('', '')
   if (numbers.charAt(0)=='0' && numbers.length==11) return numbers; 
